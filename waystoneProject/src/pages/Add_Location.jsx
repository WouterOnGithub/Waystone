      ...
      <div id="addview-content">
        ...
        <form id="input-box-gray">
            ...
            <div id="addview-discription">
                <label htmlFor="discription-location"><b>Discription</b> (max. 120 characters)</label><br />
                <textarea name="discription-location" id="discription-location" maxlength="120"></textarea>
            </div>
